...
Public Class IEFReqForm
    ...
    Private Sub Print_Click(sender As Object, e As EventArgs) Handles Print.Click
        ...
        Else
            Me.Hide()
            With OathOfUndertakingForm
                .TopLevel = False
                InspectorForm.MDIpanel.Controls.Add(OathOfUndertakingForm)
                .BringToFront()
                .Show()
            End With
        End If
    ...
    Private Sub IEFReqForm_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
