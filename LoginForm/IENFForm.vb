...
Public Class IENFForm
    ...
    Private Sub Save_Click_2(sender As Object, e As EventArgs) Handles Save.Click
        If NameOfEstablishment.Text = "" And Address.Text = "" And EmailAddress.Text = "" And CEOPresident.Text = "" And GeneralManager.Text = "" And PollutionControlOfficer.Text = "" And NatureOfBusiness.Text = "" And ContactNumber.Text = "" And NameOfAccreditedWasteHauler.Text = "" And ControlNumber.Text = "" And BrgyClearance.Text = "" And DTISEC.Text = "" And ECC.Text = "" And PTO.Text = "" And DP.Text = "" And DENRIDNumber.Text = "" And AccreditedWasteHauler.Text = "" And PDEALicense.Text = "" Then
        ...
        Else
            ...
            connection.Open()
            command = New SqlCommand("select * from IndustrialEstablishmentNonFood_tbl where ControlNumber = '" & ControlNumber.Text & "'", connection)
    ...
    Private Sub DeleteButton_Click(sender As Object, e As EventArgs) Handles DeleteButton.Click
        If ControlNumber.Text = "" Then
            ...
            ControlNumber.Focus()
        Else
            Dim Delete As String = "Select * from IndustrialEstablishmentNonFood_tbl WHERE ControlNumber = '" & ControlNumber.Text & "'"
            ...
            Else
                ...
                If result = DialogResult.Yes Then
                    ...
                    'after execute the INSERT operation to save the deleted data, then execute this to delete dat
                    Dim deleteDataOfIENF As String = "delete from IndustrialEstablishmentNonFood_tbl WHERE ControlNumber =   '" & ControlNumber.Text & "'"
                    Dim cmdToDeleteDataOfIENF As New SqlCommand(deleteDataOfIENF, connection)
                    Dim adapterToDeleteDataOfIENF As New SqlDataAdapter(cmdToDeleteDataOfIENF)
                    Dim tableToDeleteDataOfIENF As New DataTable
                    adapterToDeleteDataOfIENF.Fill(tableToDeleteDataOfIENF)
                    If connection.State = ConnectionState.Closed Then connection.Open()
                    cmdToDeleteDataOfIENF.ExecuteNonQuery()
                    If connection.State = ConnectionState.Open Then connection.Close()
    ...
    Private Sub IndustrialEstablishmentNonFoodForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'TODO: This line of code loads data into the 'Cenro_DBDataSet.IndustrialEstablishmentNonFood_tbl' table. You can move, or remove it, as needed.
        Me.IndustrialEstablishmentNonFood_tblTableAdapter.Fill(Me.Cenro_DBDataSet.IndustrialEstablishmentNonFood_tbl)

        Me.KeyPreview = True
    End Sub

    Private Sub Search1_TextChanged(sender As Object, e As EventArgs) Handles SearchReq.TextChanged
        FilterDatareq()
    End Sub
    ...
    Public Sub FilterDatareq()
        ...
        ElseIf ComboBox1.SelectedItem.ToString() = "by Control Number" Then
            Dim searchQuery As String = "SELECT * From IndustrialEstablishmentNonFood_tbl WHERE Convert(nvarchar(50),ControlNumber)  like '%" & SearchReq.Text & "%' "
        ...
        ElseIf ComboBox1.SelectedItem.ToString() = "by Name of Establishment" Then
            Dim searchQuery1 As String = "SELECT * From IndustrialEstablishmentNonFood_tbl WHERE Convert(nvarchar(50),NameOfEstablishment)  like '%" & SearchReq.Text & "%' "
    ...
    Public Sub FilterData()
        ...
        ElseIf ComboBox2.SelectedItem.ToString() = "by Control Number" Then
            Dim searchQuery As String = "SELECT * From IndustrialEstablishmentNonFood_tbl WHERE Convert(nvarchar(50),ControlNumber)  like '%" & Search.Text & "%' "
            Dim command As New SqlCommand(searchQuery, connection)
            Dim adapter As New SqlDataAdapter(command)
            Dim table As New DataTable()
            adapter.Fill(table)
        ...
        ElseIf ComboBox2.SelectedItem.ToString() = "by Name of Establishment" Then
            Dim searchQuery1 As String = "SELECT * From IndustrialEstablishmentNonFood_tbl WHERE Convert(nvarchar(50),NameOfEstablishment)  like '%" & Search.Text & "%' "
            Dim command1 As New SqlCommand(searchQuery1, connection)
            Dim adapter1 As New SqlDataAdapter(command1)
            Dim table1 As New DataTable()
            adapter1.Fill(table1)
        ...
        ElseIf ComboBox2.SelectedItem.ToString() = "by Address" Then
            Dim searchQuery2 As String = "SELECT * From IndustrialEstablishmentNonFood_tbl WHERE Convert(nvarchar(50),Address)  like '%" & Search.Text & "%' "
            Dim command2 As New SqlCommand(searchQuery2, connection)
            Dim adapter2 As New SqlDataAdapter(command2)
            Dim table2 As New DataTable()
            adapter2.Fill(table2)
    ...
    Private Sub IENFForm_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
