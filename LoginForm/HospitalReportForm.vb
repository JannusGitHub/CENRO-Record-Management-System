Public Class HospitalReportForm
    Private Sub HospitalReportForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub button_Click(sender As Object, e As EventArgs) Handles button.Click
        ...
        Try
            If Not String.IsNullOrEmpty(SearchButton.Text) Then
                ...
                Me.HospitalAndMedicalEstablishment_tblBindingSource.Filter =
                ...
                Me.ReportViewer1.RefreshReport()
            Else
                Me.HospitalAndMedicalEstablishment_tblBindingSource.RemoveFilter()
                HospitalReportForm_Load(sender, e)
