...
Public Class HospitalAndMedicalReqForm
    Dim connection As New SqlConnection("Data Source=DESKTOP-KFTOEG8;Initial Catalog=cenro_DB;Integrated Security=True")
    Private Sub HospitalAndMedicalReqForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Print_Click(sender As Object, e As EventArgs) Handles Print.Click
        ...
        Else
            Me.Hide()
            With HospitalOathOfUndertakingForm
                .TopLevel = False
                InspectorForm.MDIpanel.Controls.Add(HospitalOathOfUndertakingForm)
                .BringToFront()
                .Show()
            End With
        End If
    ...
    Private Sub HospitalAndMedicalReqForm_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
