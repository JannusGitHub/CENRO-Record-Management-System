...
Public Class IENFReqForm
    Dim connection As New SqlConnection("Data Source=DESKTOP-KFTOEG8;Initial Catalog=cenro_DB;Integrated Security=True")

    Private Sub IndustrialEstablishmentReqForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Print_Click(sender As Object, e As EventArgs) Handles Print.Click
        If NameOfEstablishment1.Text = "" Then
            MessageBox.Show("Fill the Name of Establishment field!", "Confirmation", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Else
            Me.Hide()
            With IENFOathOfUndertakingForm
                .TopLevel = False
                InspectorForm.MDIpanel.Controls.Add(IENFOathOfUndertakingForm)
                .BringToFront()
                .Show()
            End With
        End If
