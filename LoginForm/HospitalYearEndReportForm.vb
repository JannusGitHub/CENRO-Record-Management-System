Public Class HospitalYearEndReportForm
    Private Sub HospitalYearEndReportForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'HospitalYearEndReportDataSet.YearEndReport_tbl' table. You can move, or remove it, as needed.
        Me.YearEndReport_tblTableAdapter.FillByHospital(Me.HospitalYearEndReportDataSet.YearEndReport_tbl)
        ...
        Try
            If Not String.IsNullOrEmpty(SearchButton.Text) Then
                ...
                Me.YearEndReport_tblBindingSource.Filter =
                    "(Convert(HospitalAndMedicalEstablishmentID, 'System.String') LIKE '%" & keyword & "%')" &
            ...
            Else
                ...
                HospitalYearEndReportForm_Load(sender, e)
