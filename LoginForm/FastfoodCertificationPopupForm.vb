...
Public Class FastfoodCertificationPopupForm
    ...
    Private Sub Print_Click(sender As Object, e As EventArgs) Handles Print.Click
        Try
            Dim command As New SqlCommand("SELECT * FROM FastfoodCanteenAndRestaurant_tbl WHERE ControlNumber = @ControlNumber1", connection)
            ...
            If reader.Read = True Then
                ...
                If BrgyClearanceWithCTC = "Compliant" And DTI_SEC = "Compliant" And ECC = "Compliant" And PTO = "Compliant" And DP = "Compliant" And AccreditedWasteHauler = "Compliant" And SelfMonitoringReport = "Compliant" Then
                    ...
                    With FastfoodPrintedCertificationForm
                        .TopLevel = False
                        Main.MDIpanel.Controls.Add(FastfoodPrintedCertificationForm)
                        .BringToFront()
                        .Show()
                    End With
                    reader.Close()
    ...
    Private Sub FastfoodCertificationPopupForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.KeyPreview = True
    End Sub

    Private Sub FastfoodCertificationPopupForm_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
