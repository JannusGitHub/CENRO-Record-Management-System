...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("FastFoodYearEndReportDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class FastFoodYearEndReportDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As FastFoodYearEndReportDataSet = CType(MyBase.Clone,FastFoodYearEndReportDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "FastFoodYearEndReportDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/FastFoodYearEndReportDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As FastFoodYearEndReportDataSet = New FastFoodYearEndReportDataSet()
    ...
    Partial Public Class YearEndReport_tblDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddYearEndReport_tblRow(ByVal Fastfood_Canteen_RestaurantID As Integer, ByVal NameOfEstablishment As String, ByVal Address As String, ByVal ControlNumber As String, ByVal Status As String) As YearEndReport_tblRow
            Dim rowYearEndReport_tblRow As YearEndReport_tblRow = CType(Me.NewRow,YearEndReport_tblRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Fastfood_Canteen_RestaurantID, NameOfEstablishment, Address, ControlNumber, Status}
...
Namespace FastFoodYearEndReportDataSetTableAdapters
    ...
    Partial Public Class YearEndReport_tblTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[YearEndReport_tbl] WHERE (([YearEndReportID] = @Original_YearE"& _ 
                "ndReportID) AND ((@IsNull_Fastfood_Canteen_RestaurantID = 1 AND [Fastfood_Cantee"& _ 
                "n_RestaurantID] IS NULL) OR ([Fastfood_Canteen_RestaurantID] = @Original_Fastfoo"& _ 
                "d_Canteen_RestaurantID)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[YearEndReport_tbl] ([Fastfood_Canteen_RestaurantID], [NameOfEs"& _ 
                "tablishment], [Address], [ControlNumber], [Status]) VALUES (@Fastfood_Canteen_Re"& _ 
                "staurantID, @NameOfEstablishment, @Address, @ControlNumber, @Status);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Ye"& _ 
                "arEndReportID, Fastfood_Canteen_RestaurantID, NameOfEstablishment, Address, Cont"& _ 
                "rolNumber, Status FROM YearEndReport_tbl WHERE (YearEndReportID = SCOPE_IDENTITY"& _ 
                "())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[YearEndReport_tbl] SET [Fastfood_Canteen_RestaurantID] = @Fastfood_"& _ 
                "Canteen_RestaurantID, [NameOfEstablishment] = @NameOfEstablishment, [Address] = "& _ 
                "@Address, [ControlNumber] = @ControlNumber, [Status] = @Status WHERE (([YearEndR"& _ 
                "eportID] = @Original_YearEndReportID) AND ((@IsNull_Fastfood_Canteen_RestaurantI"& _ 
                "D = 1 AND [Fastfood_Canteen_RestaurantID] IS NULL) OR ([Fastfood_Canteen_Restaur"& _ 
                "antID] = @Original_Fastfood_Canteen_RestaurantID)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT YearEndReportID, Fa"& _ 
                "stfood_Canteen_RestaurantID, NameOfEstablishment, Address, ControlNumber, Status"& _ 
                " FROM YearEndReport_tbl WHERE (YearEndReportID = @YearEndReportID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT YearEndReportID, Fastfood_Canteen_RestaurantID, NameOfEstablishment, Addre"& _ 
                "ss, ControlNumber, Status FROM dbo.YearEndReport_tbl"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        YearEndReport_tbl.Fastfood_Canteen_RestaurantID, YearEndReport_tbl."& _ 
                "NameOfEstablishment, YearEndReport_tbl.Address, YearEndReport_tbl.ControlNumber,"& _ 
                " YearEndReport_tbl.Status"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            YearEndReport_tbl INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"       "& _ 
                "                  FastfoodCanteenAndRestaurant_tbl ON YearEndReport_tbl.Fastfood"& _ 
                "_Canteen_RestaurantID = FastfoodCanteenAndRestaurant_tbl.Fastfood_Canteen_Restau"& _ 
                "rantID"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As FastFoodYearEndReportDataSet.YearEndReport_tblDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As FastFoodYearEndReportDataSet.YearEndReport_tblDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As FastFoodYearEndReportDataSet.YearEndReport_tblDataTable = New FastFoodYearEndReportDataSet.YearEndReport_tblDataTable()
        ...
        Public Overloads Overridable Function FillByFastFood(ByVal dataTable As FastFoodYearEndReportDataSet.YearEndReport_tblDataTable) As Integer
        ...
        Public Overloads Overridable Function GetDataByFastFood() As FastFoodYearEndReportDataSet.YearEndReport_tblDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Dim dataTable As FastFoodYearEndReportDataSet.YearEndReport_tblDataTable = New FastFoodYearEndReportDataSet.YearEndReport_tblDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As FastFoodYearEndReportDataSet.YearEndReport_tblDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As FastFoodYearEndReportDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_YearEndReportID As Integer, ByVal Original_Fastfood_Canteen_RestaurantID As Global.System.Nullable(Of Integer)) As Integer
            ...
            If (Original_Fastfood_Canteen_RestaurantID.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(2).Value = CType(Original_Fastfood_Canteen_RestaurantID.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal Fastfood_Canteen_RestaurantID As Global.System.Nullable(Of Integer), ByVal NameOfEstablishment As String, ByVal Address As String, ByVal ControlNumber As String, ByVal Status As String) As Integer
            If (Fastfood_Canteen_RestaurantID.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(Fastfood_Canteen_RestaurantID.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal Fastfood_Canteen_RestaurantID As Global.System.Nullable(Of Integer), ByVal NameOfEstablishment As String, ByVal Address As String, ByVal ControlNumber As String, ByVal Status As String, ByVal Original_YearEndReportID As Integer, ByVal Original_Fastfood_Canteen_RestaurantID As Global.System.Nullable(Of Integer), ByVal YearEndReportID As Integer) As Integer
            If (Fastfood_Canteen_RestaurantID.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(0).Value = CType(Fastfood_Canteen_RestaurantID.Value,Integer)
            Else
            ...
            If (Original_Fastfood_Canteen_RestaurantID.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_Fastfood_Canteen_RestaurantID.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Fastfood_Canteen_RestaurantID As Global.System.Nullable(Of Integer), ByVal NameOfEstablishment As String, ByVal Address As String, ByVal ControlNumber As String, ByVal Status As String, ByVal Original_YearEndReportID As Integer, ByVal Original_Fastfood_Canteen_RestaurantID As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Fastfood_Canteen_RestaurantID, NameOfEstablishment, Address, ControlNumber, Status, Original_YearEndReportID, Original_Fastfood_Canteen_RestaurantID, Original_YearEndReportID)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As FastFoodYearEndReportDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As FastFoodYearEndReportDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._yearEndReport_tblTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As FastFoodYearEndReportDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._yearEndReport_tblTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As FastFoodYearEndReportDataSet) As Integer
