...
Public Class IENFCertificationPopupForm
    ...
    Private Sub Print_Click(sender As Object, e As EventArgs) Handles Print.Click
        Try
            Dim command As New SqlCommand("SELECT * FROM IndustrialEstablishmentNonFood_tbl WHERE ControlNumber = @ControlNumber1", connection)
            ...
            If reader.Read = True Then
                ...
                If BrgyClearanceWithCTC = "Compliant" And DTI_SEC = "Compliant" And ECC = "Compliant" And PTO = "Compliant" And DP = "Compliant" And DENR_IDNumber = "Compliant" And AccreditedWasteHauler = "Compliant" And PDEALicense = "Compliant" And SelfMonitoringReport = "Compliant" Then
                    ...
                    With IENFPrintedCertificateForm
                        .TopLevel = False
                        Main.MDIpanel.Controls.Add(IENFPrintedCertificateForm)
                        .BringToFront()
                        .Show()
                    End With
                    reader.Close()
    ...
    Private Sub IENFCertificationPopupForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.KeyPreview = True
    End Sub

    Private Sub IENFCertificationPopupForm_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
