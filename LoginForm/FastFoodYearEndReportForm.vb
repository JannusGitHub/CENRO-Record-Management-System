Public Class FastFoodYearEndReportForm
    Private Sub FastFoodYearEndReportForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'FastFoodYearEndReportDataSet.YearEndReport_tbl' table. You can move, or remove it, as needed.
        Me.YearEndReport_tblTableAdapter.FillByFastFood(Me.FastFoodYearEndReportDataSet.YearEndReport_tbl)
        ...
        Try
            If Not String.IsNullOrEmpty(SearchButton.Text) Then
                ...
                Me.YearEndReport_tblBindingSource.Filter =
                    "(Convert(Fastfood_Canteen_RestaurantID, 'System.String') LIKE '%" & keyword & "%')" &
            ...
            Else
                ...
                FastFoodYearEndReportForm_Load(sender, e)
